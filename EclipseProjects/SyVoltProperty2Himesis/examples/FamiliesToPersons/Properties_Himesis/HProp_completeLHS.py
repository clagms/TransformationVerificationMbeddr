...
class HProp_completeLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HProp_completeLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HProp_completeLHS, self).__init__(name='HProp_completeLHS', num_nodes=14, edges=[])
        
        # Add the edges
        self.add_edges([(3, 0), (4, 0), (12, 1), (1, 5), (2, 6), (2, 12), (10, 3), (11, 4), (5, 10), (8, 13), (13, 10), (6, 8), (11, 7), (7, 9)])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('4477ba5f-31bc-491a-90bb-c0b35dc0d587')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('3361cbd1-ce83-4aa9-87cb-b7be824b48fc')
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('a6200360-e110-42c0-a998-2eb834015d98')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('afdad99a-11a3-4ceb-bf7d-3ce51f5bb814')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('16ba4f50-75f1-49f8-ab85-ed5cd9ede866')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('55af72ca-7c49-4529-8809-95a119f85ad9')
...
.""")
        ...
        self.vs[5]["GUID__"] = UUID('6e2aee83-1a54-4099-9cb5-5dbb86730d4f')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('5c1b1822-6c3d-4c34-94e2-5c923384219f')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('b6944b6c-29e5-4036-afc4-06bfa82f04cf')
...
"""
        ...
        self.vs[8]["GUID__"] = UUID('c273a49a-7182-44c0-bef7-10f24d541fdc')
...
.""")
        ...
        self.vs[9]["MT_pre__value"] = pickle.loads("""V\u000a#===============================================================================\u000a# This code is executed when evaluating if a node shall be matched by this rule.\u000a# You can access the value of the current node's attribute value by: attr_value.\u000a# You can access any attribute x of this node by: this['x'].\u000a# If the constraint relies on attribute values from other nodes,\u000a# use the LHS/NAC constraint instead.\u000a# The given constraint must evaluate to a boolean expression.\u000a#===============================================================================\u000a\u000areturn attr_value == "Maria"\u000a
p1
.""")
        self.vs[9]["MT_dirty__"] = False
        self.vs[9]["GUID__"] = UUID('4261d6a9-9d31-4ae1-b187-3503327bf358')
...
.""")
        self.vs[10]["mm__"] = """MT_pre__Female_S"""
...
"""
        ...
        self.vs[10]["GUID__"] = UUID('62ed3e7d-b7c5-4e30-b743-7798eafa50be')
...
.""")
        ...
        self.vs[11]["GUID__"] = UUID('fc9fa656-ab41-4994-9772-1dcfa66917bf')
        self.vs[12]["MT_subtypeMatching__"] = False
        self.vs[12]["MT_label__"] = """14"""
        self.vs[12]["MT_subtypes__"] = pickle.loads("""(lp1
.""")
        self.vs[12]["mm__"] = """MT_pre__trace_link"""
        self.vs[12]["MT_dirty__"] = False
        self.vs[12]["GUID__"] = UUID('bfd0eeb7-0298-4e53-9e61-d5fbd391725c')
...
.""")
        ...
        self.vs[13]["GUID__"] = UUID('63ee9a72-9bb8-47f6-ae5c-b6c33cd9de7a')
